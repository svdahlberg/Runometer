...
class RunRatingTests: XCTestCase {
    ...
    func testDistanceRatingReturnsOneIfDistanceIsTheLongestOfTheDistances() {
        ...
        let distanceRating = RunRatingCalculator.distanceRating(for: distance, comparedTo: distances)
    ...
    func testDistanceRatingReturnsZeroIfDistanceIsTheShortestOfTheDistances() {
        ...
        let distanceRating = RunRatingCalculator.distanceRating(for: distance, comparedTo: distances, minimumRating: 0, maximumRating: 1)
    ...
    func testTimeRatingReturnsZeroIfRunsIsEmpty() {
        ...
        let duration = 0
        let timeRating = RunRatingCalculator.timeRating(for: duration, comparedTo: durations, minimumRating: 0, maximumRating: 1)
    ...
    func testTimeRatingReturnsMinimumRatingIfPaceOfRunIsTheSlowestOutOfRuns() {
        ...
        let timeRating = RunRatingCalculator.timeRating(for: duration, comparedTo: durations, minimumRating: 0.1, maximumRating: 1)
